...
@section('content')
    <div class="bg-white shadow rounded-lg p-6">
        ...
        <x-link-button href="{{ route('books.create') }}" class="mb-4 bg-gray-800 text-white px-4 py-2 rounded hover:bg-blue-700">
            {{ __('Add New Book') }}
        </x-link-button>
        ...
        <div class="flex justify-between items-center mb-4">
            <div class="flex space-x-2">
                ...
                <select id="show" name="show" class="border rounded-lg px-4 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500">
